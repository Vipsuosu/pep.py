...
from events import ToggleBlockNonFriendPM
...
class handler(requestsManager.asyncRequestHandler):
			...
			try:
				...
				while pos < len(requestData):
					...
					eventHandler = {
						...
						packetIDs.client_userToggleBlockNonFriendPM: handleEvent(ToggleBlockNonFriendPM),
	...
	@tornado.gen.engine
	def asyncGet(self):
		html = 	"<html><head><title>Gatari Bancho server</title>"
