...
class tokenList:
	...
	def addToken(self, userID, ip = "", irc = False, timeOffset=0, tournament=False, friendPM=False):
		"""
		...
		:return: token object
		"""
		newToken = osuToken.token(userID, ip=ip, irc=irc, timeOffset=timeOffset, tournament=tournament,friendPM=friendPM)
