...
class slot:
	def __init__(self, status = slotStatuses.FREE):
		self.status = status
...
class match:
	def __init__(self, matchID, matchName, matchPassword, beatmapID, beatmapName, beatmapMD5, gameMode, hostUserID, players, isTourney=False):
		"""
	...
	def invite(self, fro, to):
		...
		# FokaBot is too busy
		if to == 999:
			chat.sendMessage("FokaBot", froToken.username, "I would love to join your match, but I'm busy keeping gatari up and running. Sorry. Beep Boop.")
		else:
		# Send message
